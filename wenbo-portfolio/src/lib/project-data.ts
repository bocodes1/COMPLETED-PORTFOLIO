...
export const projects: Project[] = [
  {
    ...
    gradient: "from-white/[0.10] via-white/[0.04] to-transparent",
    number: "01",
    hasVideo: true,
  ...
  },
  {
    ...
    gradient: "from-white/[0.07] via-white/[0.03] to-transparent",
    number: "03",
    hasVideo: false,
  },
  {
    ...
    gradient: "from-white/[0.09] via-white/[0.04] to-transparent",
    number: "04",
    hasVideo: false,
  },
];
